            ...
            if (b[n].getHealth() > 0) {
                ...
                if (choices[0] == 1) {
                    ...
                    if (b[n] instanceof Cruiser || b[n] instanceof Destroyer) {
                        System.out.println("This boat moves twice. Choose next move: \n");
                        choices[1] = s.nextInt();
                    }
                    System.out.println(b[n].act(choices, w));
                    // TODO Should add loooping through choices[][] to other boats as well ???
                    // TODO should reset choices to null then
                    n++;
                }
            } else n++;
        }
